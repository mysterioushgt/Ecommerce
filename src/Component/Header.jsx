        ...
        <div className="d-inline-flex align-items-center ">
          <div className="dropdown mx-2">
            ...
            <ul className="dropdown-menu dropdown-menu-right">
              ...
              <li><a href="#" className="dropdown-item"> Sign Up</a></li>
            </ul>
          </div>
          <div className="dropdown mx-2">
        ...
        <nav className="navbar py-3 navbar-dark bg-secondary navbar-expand-lg">
          ...
          <div className="navbar-collapse collapse justify-content-between" id="navbarhome">
            <ul className="navbar-nav">
              ...
              <li><Link to="/shopdet" className="nav-link">Shop Details</Link></li>
              <div className="dropdown">
                <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                <ul className="dropdown-menu">
                  <li><Link to="/shopcart" className="dropdown-item aa">shoppingcart</Link></li>
